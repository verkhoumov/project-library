<div class="container">
	...
	<h1 class="h3 page-header-h1">Добавить новость</h1>
		...
		<div class="well">
			<div class="row">
				...
				<div class="col-xs-7 text-right">
					...
					<button class="btn btn-success" name="add" value="1" type="submit"><span class="glyphicon glyphicon-floppy-save icon"></span> Добавить новость</button>
				</div>
			</div>
		</div>
	</form>
