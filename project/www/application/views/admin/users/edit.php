<div class="container">
	...
	<h1 class="h3 page-header-h1">Редактировать <span class="text-lowercase">{group_name_plural}</span></h1>
	...
	<form method="POST">
		...
		<div class="form-group">
			...
			<span class="help-block">Старый пароль зашифрован! Чтобы изменить пароль, укажите новый.</span>
		</div>
